...
import 'package:teslo_shop/features/shared/services/camera_gallery_service_impl.dart';
import 'package:teslo_shop/features/shared/widgets/full_screen_loader.dart';

import '../widgets/custom_product_field.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField(
            ...
            onChanged: notifier.onSlugChange,
          ...
          CustomProductField(
            ...
            onChanged: (value) =>
                notifier.onPriceChange(double.tryParse(value) ?? -1),
          ),
          const SizedBox(height: 15),
          const Text('Extras'),
          _SizeSelector(
            selectedSizes: productForm.sizes,
            onSizesChanged: notifier.onSizedChanges,
          ),
          const SizedBox(height: 5),
          _GenderSelector(
            selectedGender: productForm.gender,
            onGenderChange: notifier.onGenderChange,
          ),
          const SizedBox(height: 15),
          CustomProductField(
            isTopField: true,
            ...
            onChanged: (value) =>
                notifier.onStockChange(int.tryParse(value) ?? -1),
          ),
          CustomProductField(
            maxLines: 6,
            label: 'Descripción',
            ...
            onChanged: notifier.onDescriptionChange,
          ),
          CustomProductField(
            isBottomField: true,
            maxLines: 2,
